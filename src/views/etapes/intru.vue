      ...
      <v-row>
        <v-col>
          <div align="center">
            ...
            <v-text-field v-model="legende[0]" label="Légende" outlined></v-text-field>
          </div>
        </v-col>
        <v-col>
          <div align="center">
            ...
            <v-text-field v-model="legende[1]" label="Légende" outlined></v-text-field>
          </div>
        </v-col>
      </v-row>
      <v-row>
        <v-col>
          <div align="center">
            ...
            <v-text-field v-model="legende[2]" label="Légende" outlined></v-text-field>
          </div>
        </v-col>
        <v-col>
          <div align="center">
