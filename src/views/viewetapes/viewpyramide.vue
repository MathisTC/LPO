  ...
  <div class="flex items-center">
    <Phone :etape="etape.n_etape + '/' + etapeMax" class="flex flex-col">
      <div class="bg-gray-200 rounded-md w-full p-3 overflow-y-visible">
        ...
        <p class="text-[9px] text-gray-600" ref="etape_texte">
          Remplir la pyramide jusqu'au sommet, selon le principe suivant : additionner deux bulles adjacentes (côte à
          côte), la somme correspond à la bulle au-dessous.
        </p>

        <p class="text-[12px]">{{ etape.question }}</p>


        <div class="flex flex-col m-3 justify-center items-center gap-4">
          <div class="flex gap-4 items-center">
            <div class="h-8 w-8 rounded-full bg-green-600 text-white flex items-center justify-center">1</div>
            <div class="h-8 w-8 rounded-full bg-green-600 text-white flex items-center justify-center">5</div>
            <div class="h-8 w-8 rounded-full bg-green-600 text-white flex items-center justify-center">3</div>
            <div class="h-8 w-8 rounded-full bg-green-600 text-white flex items-center justify-center">2</div>
          </div>
          <div class="flex gap-4 items-center">
            <div class="h-8 w-8 rounded-full bg-green-600 text-white flex items-center justify-center"></div>
            <div class="h-8 w-8 rounded-full bg-green-600 text-white flex items-center justify-center"></div>
            <div class="h-8 w-8 rounded-full bg-green-600 text-white flex items-center justify-center"></div>
          </div>
