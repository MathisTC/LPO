  ...
  <div v-if="user.loggedIn" class="center-div">
    ...
    <v-row v-if="etape.nom">
      <v-col>
        ...
        <br>
        <v-textarea  label="Description position code" rows="3" required auto-grow v-model="etape.texte" />
        <br>
        <v-textarea class="selectCode" label="Code à trouver" rows="1" no-resize required v-model="etape.code"></v-textarea>
        <br>
      </v-col>
      <v-col>
