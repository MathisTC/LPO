  ...
  <div v-if="user.loggedIn" class="center-div">
    ...
    <v-row v-if="etape.nom">
      <v-col>
        ...
        <v-textarea label="Nom du Rebus" rows="1" variant="outlined" no-resize autofocus required
          v-model="etape.nom"></v-textarea>
        <br>
        <v-textarea label="Question" rows="3" required auto-grow v-model="etape.question" />
        <br>
        <br>
      ...
      <v-col>
        ...
        <br>
        <br>
        <v-textarea label="Texte" rows="3" required auto-grow v-model="etape.texteApresReponse" />
        <br>
      </v-col>
      <v-col>
